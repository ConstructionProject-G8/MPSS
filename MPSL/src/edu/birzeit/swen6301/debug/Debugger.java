...
/**
 * 
 * This class used to do all debugging scenarios to confirm that draft code is running will.<p>
 * <p>
 * Main Functions:<p>
 * 1. Debug Mirror class.<p>
 * 2. Debug Segment class.<p>
 * 3. Debug Manifest class.<p>
 * 4. Debug MultiPartStream class.<p>
 * 5. Write all events and errors in log file.<p>
 * <p>
 * @author 
 *
 */
public class Debugger {
	...
	/**
	 * Used to debug data fetching for certain manifest url by using MultiPartStream class by referent methods.
	 */
